...
public:
  ...
  virtual void loop() {
    ...
    int level = (int)lerp(light, minLight[mode], maxLight[mode], 0.0, 5.0); //lerp()Calculates a number between two numbers at a specific increment. 
